        ...
        <div className="max-w-2xl mx-auto space-y-6">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Управляйте доступом к доске</CardDescription>
            </CardHeader>
                      ...
                      <div key={member.id} className="flex items-center justify-between gap-3">
                        ...
                        <div className="flex items-center gap-2 shrink-0">
                          {member.role === "owner" ? (
                            <Badge
                              variant="outline"
                              className="gap-1 text-xs bg-yellow-50 text-yellow-700 border-yellow-200"
                            >
                            ...
                            >
                              <SelectTrigger className="h-7 text-xs w-28">
                                <SelectValue
                                  placeholder={
                                    { owner: "Владелец", member: "Участник" }[member.role]
                                  }
                                />
                              </SelectTrigger>
                              <SelectContent>
